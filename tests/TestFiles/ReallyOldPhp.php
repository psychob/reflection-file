...
<HEAD>
    ...
    <? if (user_nav_type() == 'ie') {
        echo '<LINK REL="stylesheet" HREF="ie_addon.css" TYPE="text/css">';
    } ?>
</HEAD>
<BODY>
<TABLE id="tabela" align="center">
    <TR>
        <TD id="naglowek">
            <h1 onmouseover="javascript:ShowTool('tt_nfo');" onmouseout="javascript:HideTT();"><sup>Re</sup>Core
                Software</h1>
        </TD>
    </TR>
    <TR>
        <TD id="links">
            <a href="index.php?what=mainframe" onmouseover="javascript:ShowTool('tt_stronka');"
               onmouseout="javascript:HideTT();">Strona Główna</a> -
            <a href="index.php?what=projekty" onmouseover="javascript:ShowTool('tt_projekty');"
               onmouseout="javascript:HideTT();">Projekty</a> -
            <a href="index.php?what=linki" onmouseover="javascript:ShowTool('tt_linki');"
               onmouseout="javascript:HideTT();">Linki</a> -
            <a href="index.php?what=ksiega" onmouseover="javascript:ShowTool('tt_ksiega');"
               onmouseout="javascript:HideTT();">Księga gości</a> -
            <a href="index.php?what=autor" onmouseover="javascript:ShowTool('tt_autor');"
               onmouseout="javascript:HideTT();">Autor</a>
        </TD>
    </TR>
    <TR>
        <TD id="motto">
            ...
            <?
                ...
                */
                if ($_GET['what']) {
                    ...
                    if ($_GET['what'] == 'mainframe') {
                        include('news.php');
                    } else if ($_GET['what'] == 'projekty') {
                        include('projekty.php');
                    } else if ($_GET['what'] == 'teksty') {
                        include('arty.php');
                    } else if ($_GET['what'] == 'ksiega') {
                        include('ksiega.php');
                    } else if ($_GET['what'] == 'autor') {
                        include('autor.html');
                    } else if ($_GET['what'] == 'reg') {
                        include('reg/reg.php');
                    } else if ($_GET['what'] == 'linki') {
                        include('linki.html');
                    } else {
                        include('news.php');
                    }
    ...
    <TR>
        <TD id="copy">
            ...
            Tą stronę najlepjej oglądać pod <a href="http://www.mozilla.com/">Firefoxem</a> 2.0/+ i w rozdzielczości 800
            x 600
        </TD>
    </TR>
</TABLE>
<DIV class="tooltip" id="tt_stronka">Tutaj wszelkie newsy ze mojej strony</DIV>
<DIV class="tooltip" id="tt_projekty">Tutaj możesz znaleźć trochę moich projektów, są tutaj i te skończone i te
    nieskończone
</DIV>
...
<DIV class="toolnfo" id="tt_nfo">Twoje ip:<a
            href="http://<? echo $_SERVER["REMOTE_ADDR"]; ?>"><? echo $_SERVER['REMOTE_ADDR']; ?></a><br>Twoja
    przeglądarka: <? echo $_SERVER["HTTP_USER_AGENT"]; ?></DIV>
